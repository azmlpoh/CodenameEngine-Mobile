...
class Script extends FlxBasic implements IFlxDestroyable {
	...
	private static function buildDefaultVariables():Map<String, Dynamic> {
		return [
			...
			"FoxCubeMesh" => foxlite.mesh.FoxCubeMesh,
			...
			"FoxFunkinSprite" => foxlite.funkin.FoxFunkinSprite,
			...
			"FoxOBJLoader" => foxlite.loaders.FoxOBJLoader,
			"FoxMTLLoader" => foxlite.loaders.FoxMTLLoader,
			"FoxDirectionalLight" => foxlite.lights.FoxDirectionalLight,
			"FoxLayer"				=> CoolUtil.getMacroAbstractClass("foxlite.FoxLayer"),
			"FoxEaseType"			=> CoolUtil.getMacroAbstractClass("foxlite.animation.FoxEaseType"),
			"FoxInstanceUpdateMode" => CoolUtil.getMacroAbstractClass("foxlite.instancing.FoxInstanceUpdateMode"),
			"FoxAreaLightShape" 	=> CoolUtil.getMacroAbstractClass("foxlite.lights.FoxAreaLightShape"),
			"FoxLightType"		 	=> CoolUtil.getMacroAbstractClass("foxlite.lights.FoxLightType"),
			"FoxBlendMode"		 	=> CoolUtil.getMacroAbstractClass("foxlite.material.FoxBlendMode"),
			"FoxDepthCompareMode" 	=> CoolUtil.getMacroAbstractClass("foxlite.material.FoxDepthCompareMode"),
			"FoxStencilCompareMode" => CoolUtil.getMacroAbstractClass("foxlite.stencil.FoxStencilCompareMode"),
			"FoxTriangleFace"	    => CoolUtil.getMacroAbstractClass("foxlite.material.FoxTriangleFace"),
			"FoxMeshBufferType"	    => CoolUtil.getMacroAbstractClass("foxlite.mesh.FoxMeshBufferType"),
			"FoxQuadFace"		    => CoolUtil.getMacroAbstractClass("foxlite.mesh.FoxQuadFace"),
			"FoxStencilActionType"  => CoolUtil.getMacroAbstractClass("foxlite.stencil.FoxStencilActionType"),
			"FoxCubemapSide" 	    => CoolUtil.getMacroAbstractClass("foxlite.texture.FoxCubemapSide"),
			"FoxMipFilter" 		    => CoolUtil.getMacroAbstractClass("foxlite.texture.FoxMipFilter"),
			"FoxTextureFilter" 	    => CoolUtil.getMacroAbstractClass("foxlite.texture.FoxTextureFilter"),
			"FoxWrapMode" 		    => CoolUtil.getMacroAbstractClass("foxlite.texture.FoxWrapMode"),
			#end
